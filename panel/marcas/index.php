...
<body>
            ...
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                <div class="position-sticky pt-3">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item ">
                            <a class="nav-link active" href="../marcas/index.php">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 registrar">
        ...
        if (isset($_POST['marca'])) {
            $query = "CALL INSERTAR_MARCA('" . $_POST['marca'] . "')";
        ...
        <form action="index.php" method="POST" class="cont-form">
            <div class="col campos">
                ...
                <input name="marca" type="text" class="form-control" maxlength="255" id="exampleFormControlInput1">
            </div>
            <br><br>
            <section>
                <input type="submit" class="btn1 btn btn-primary" name="accion" value="Registrar marca">
            </section>
        </form>
