...
if (isset($_GET['CLAVE'])) {
    ...
    $resultado = $productos->mostrarProductosPorID($id);
} else {
        ...
        <section>
            <form action="../acciones.php" method="POST" enctype="multipart/form-data" class="cont-form">
                <div class="col campos">
                    ...
                    <input value="<?php print $resultado['CLAVE']; ?>" name="clave_producto_a" type="text" class="form-control" maxlength="15" id="exampleFormControlInput1">
                </div>
                <div class="col campos">
                    <label for="exampleFormControlInput1" class="form-label">Nombre del producto:</label>
                    <input value="<?php print $resultado['PRODUCTO']; ?>" name="nombre_producto_a" type="text" class="form-control" maxlength="14" id="exampleFormControlInput1" placeholder="Inserte nombre" required>
                </div>
                ...
                <div class="mb-3 campos">
                    ...
                    <input value="<?php print $resultado['DESCRIPCION']; ?>" name="descripcion_producto_a" type="text" class="form-control" maxlength="255" id="exampleFormControlInput1" placeholder="Inserte descripción" required>
                </div>
                <div class="col-auto campos">
                    ...
                    <div class="input-group mb-2">
                        ...
                        <input value="<?php print $resultado['PRECIO']; ?>" name="precio_producto_a" type="text" class="form-control" required>
                    </div>
                </div>
                <div class="col campos">
                    <label for="exampleFormControlInput1" class="form-label">Existencias del producto:</label>
                    <input value="<?php print $resultado['EXISTENCIAS']; ?>" name="existencias_producto_a" type="number" class="form-control" placeholder="Existencias del producto" required>
                </div>
                <div class="mb-3 campos">
                    <label for="formFile" class="form-label">Marca del producto:</label>
                    <select requiered class="form-select" name="marca_producto_a" aria-label="Default select example">
                        ...
                        for ($x = 0; $x < $cantidad; $x++) {
                            ...
                            if ($item['MARCA'] == $resultado['MARCA']) {
                                echo "<option value='" . $item['ID'] . "' selected>" . $item['MARCA'] . "</option>";
                            } else {
                                echo "<option value='" . $item['ID'] . "'>" . $item['MARCA'] . "</option>";
                            }
                        }
                        ?>
                ...
                <div class="mb-3 campos">
                    ...
                    <select class="form-select" name="categoria_producto_a" aria-label="Default select example">
                        ...
                        for ($x = 0; $x < $cantidad; $x++) {
                            $item = $info_cat[$x];
                            if ($item['CATEGORIA'] == $resultado['CATEGORIA']) {
                ...
                <section class="boton1 campos">
                    <input type="submit" class="btn1 btn btn-primary" name="accion" value="Actualizar">
